...
export type GenerateOptions = {
  ...
  // #250: write an OAS enum param as a GraphQL enum argument, defined once, instead of its scalar.
  //   e.g. (petstore) get:/pet/findByStatus status: [available, pending, sold] -> an enum, not String
